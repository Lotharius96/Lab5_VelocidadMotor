...
module top ;
	...
	wire [0:0] tmpOE__Encoder_net;
	wire [0:0] tmpFB_0__Encoder_net;
	wire [0:0] tmpIO_0__Encoder_net;
	electrical [0:0] tmpSIOVREF__Encoder_net;

	cy_psoc3_pins_v1_10
		#(.id("88ade96a-249f-4e59-b116-074b54658737"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Encoder
		 (.oe(tmpOE__Encoder_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Encoder_net[0:0]}),
		  .io({tmpIO_0__Encoder_net[0:0]}),
	...
	assign tmpOE__Encoder_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("7554ba67-d9a7-4ee5-85a2-f8ce5f205dd8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    assign Net_188 = Net_166 & Net_167;

	wire [0:0] tmpOE__cruce_por_cero_net;
	wire [0:0] tmpIO_0__cruce_por_cero_net;
	wire [0:0] tmpINTERRUPT_0__cruce_por_cero_net;
	electrical [0:0] tmpSIOVREF__cruce_por_cero_net;

	cy_psoc3_pins_v1_10
		#(.id("40570bb3-7521-4130-ad80-e87010fab35b"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		cruce_por_cero
		 (.oe(tmpOE__cruce_por_cero_net),
		  .y({1'b0}),
		  .fb({Net_166}),
		  .io({tmpIO_0__cruce_por_cero_net[0:0]}),
		  .siovref(tmpSIOVREF__cruce_por_cero_net),
		  .interrupt({tmpINTERRUPT_0__cruce_por_cero_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cruce_por_cero_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__num_control_net;
	wire [0:0] tmpIO_0__num_control_net;
	wire [0:0] tmpINTERRUPT_0__num_control_net;
	electrical [0:0] tmpSIOVREF__num_control_net;

	cy_psoc3_pins_v1_10
		#(.id("9f32a4ce-ff45-4971-a194-f9940b7d017c"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		num_control
		 (.oe(tmpOE__num_control_net),
		  .y({1'b0}),
		  .fb({Net_167}),
		  .io({tmpIO_0__num_control_net[0:0]}),
		  .siovref(tmpSIOVREF__num_control_net),
		  .interrupt({tmpINTERRUPT_0__num_control_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__num_control_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
...
// Timer_v2_80(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=2, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC5, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=365, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_80, CY_CONFIG_TITLE=Timer, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer, CY_INSTANCE_SHORT_NAME=Timer, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=80, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Timer, )
module Timer_v2_80_2 (
    reset,
    interrupt,
    enable,
...
module top ;
	...
	wire [0:0] tmpOE__sync_net;
	wire [0:0] tmpFB_0__sync_net;
	wire [0:0] tmpIO_0__sync_net;
	electrical [0:0] tmpSIOVREF__sync_net;

	cy_psoc3_pins_v1_10
		#(.id("e4dcbf19-4bc3-466f-954a-c22d41ac7342"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		sync
		 (.oe(tmpOE__sync_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__sync_net[0:0]}),
		  .io({tmpIO_0__sync_net[0:0]}),
		  .siovref(tmpSIOVREF__sync_net),
		  .interrupt({Net_54}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__sync_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
